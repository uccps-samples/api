...
func (g *genCompatibility) GenerateType(c *generator.Context, t *types.Type, w io.Writer) error {
	klog.V(3).Infof("Generating Uccp compatibility for type %v", t)
	...
	if versionedMethodOrDie("CompatibilityLevel", t) == nil {
		sw.Do("// CompatibilityLevel is an autogenerated function, returning the Uccp API compatibility level.\n", args)
	...
	if versionedMethodOrDie("Internal", t) == nil {
		sw.Do("// Internal is an autogenerated function, returning the true if the type is internal to Uccp and not exposed as a supported API .\n", args)
