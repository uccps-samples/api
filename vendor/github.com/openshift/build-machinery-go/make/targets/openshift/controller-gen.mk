...
ifeq "" "$(wildcard $(CONTROLLER_GEN))"
	...
	curl -s -f -L https://github.com/uccps-samples/kubernetes-sigs-controller-tools/releases/download/$(CONTROLLER_GEN_VERSION)/controller-gen-$(GOHOSTOS)-$(GOHOSTARCH) -o '$(CONTROLLER_GEN)'
