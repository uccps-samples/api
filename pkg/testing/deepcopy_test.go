...
import (
	...
	apps "github.com/uccps-samples/api/apps/v1"
	authorization "github.com/uccps-samples/api/authorization/v1"
	build "github.com/uccps-samples/api/build/v1"
	image "github.com/uccps-samples/api/image/v1"
	network "github.com/uccps-samples/api/network/v1"
	oauth "github.com/uccps-samples/api/oauth/v1"
	project "github.com/uccps-samples/api/project/v1"
	quota "github.com/uccps-samples/api/quota/v1"
	route "github.com/uccps-samples/api/route/v1"
	security "github.com/uccps-samples/api/security/v1"
	template "github.com/uccps-samples/api/template/v1"
	user "github.com/uccps-samples/api/user/v1"
)
