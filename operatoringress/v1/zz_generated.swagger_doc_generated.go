...
var map_DNSRecord = map[string]string{
	"":       "DNSRecord is a DNS record managed in the zones defined by dns.config.uccp.io/cluster .spec.publicZone and .spec.privateZone.\n\nCluster admin manipulation of this resource is not supported. This resource is only for internal communication of Uccp operators.\n\nCompatibility level 1: Stable within a major release for a minimum of 12 months or 3 minor releases (whichever is longer).",
